...
public class SecurityConfig {
  ...
  public CorsConfigurationSource corsConfigurationSource() {
    ...
    configuration.addAllowedOrigin("http://localhost:4200"); // Cambia según tu dominio
  ...
  public AccessDeniedHandler customAccessDeniedHandler() {
    return (request, response, accessDeniedException) -> {
      ...
      response.getWriter().write(
          "{ \"message\": \"Access Denied\", \"details\": \"You do not have permission to access this resource.\" }");
    };
  }
  ...
  public AuthenticationEntryPoint customAuthenticationEntryPoint() {
    return (request, response, authException) -> {
      ...
      response.setContentType("application/json");
      response.getWriter().write(
          "{ \"message\": \"Unauthorized\", \"details\": \"You need to authenticate to access this resource.\" }");
    };
  }
}
